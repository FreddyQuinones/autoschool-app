...
export default function StudentsPage() {
  ...
  const handlePictureSuccess = (updated) => {
    // Reemplaza en el array de estudiantes el registro cuyo id coincida con el actualizado.
    // Esto evita recargar toda la lista desde el servidor y actualiza la UI de inmediato.
